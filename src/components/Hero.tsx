      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-4 max-w-3xl mx-auto leading-relaxed">
            Descubre la magia del turismo rural comunitario en la Vereda Palomar de Anzoátegui, Tolima. 
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed opacity-90">
            Kilómetro vertical, biciturismo de montaña, aviturismo y plantas epífitas 
            te esperan en el corazón de los Andes colombianos.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm opacity-90">Rutas en Palomar</div>
            </div>
            <div className="text-center">
              <div className="flex justify-center mb-2">
